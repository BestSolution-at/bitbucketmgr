...
public class BitbucketmgrPackageImpl extends EPackageImpl implements BitbucketmgrPackage {
	 ...
	 * @generated
	 */
	public EReference getWorkspace_ProjectList() {
	 ...
	 * @generated
	 */
	public EReference getProject_RepositoryList() {
	 ...
	 * @generated
	 */
	public EAttribute getProject_Icon() {
	...
	public void createPackageContents() {
		...
		createEReference(workspaceEClass, WORKSPACE__PROJECT_LIST);

		projectEClass = createEClass(PROJECT);
		createEAttribute(projectEClass, PROJECT__NAME);
		createEReference(projectEClass, PROJECT__REPOSITORY_LIST);
		createEAttribute(projectEClass, PROJECT__ICON);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkspace_ProjectList(), this.getProject(), null, "projectList", null, 0, -1, Workspace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(projectEClass, Project.class, "Project", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProject_Name(), ecorePackage.getEString(), "name", null, 0, 1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProject_RepositoryList(), this.getRepository(), null, "repositoryList", null, 0, -1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProject_Icon(), ecorePackage.getEByteArray(), "icon", null, 0, 1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
